...
_ROLE_RULES: list[tuple[str, str]] = [
    ...
    ("evidence/13_tmf_deforestation_", "jrc_tmf_deforestation_mask_png"),
    ("evidence/14_tmf_degradation_", "jrc_tmf_degradation_mask_png"),
    ("evidence/15_radd_confirmed_alerts.png", "radd_confirmed_alert_mask_png"),
    ("evidence/16_radd_low_confidence_alerts.png", "radd_low_confidence_alert_mask_png"),
    ("evidence/17_radd_alerts_confirmed_low_confidence.png", "radd_alerts_by_confidence_png"),
    ...
    ("tmf_deforestation_", "jrc_tmf_deforestation_mask"),
    ("tmf_degradation_", "jrc_tmf_degradation_mask"),
    ("tmf_change_debug.json", "jrc_tmf_change_debug"),
    ("tmf_change_", "jrc_tmf_change_summary"),
    ("radd_confirmed_alert_mask.geojson", "radd_confirmed_alert_mask"),
    ("radd_low_confidence_alert_mask.geojson", "radd_low_confidence_alert_mask"),
    ("radd_alerts_debug.json", "radd_alerts_debug"),
    ("radd_alerts_summary.json", "radd_alerts_summary"),
    ("map/map_config.json", "report_map_config"),
